            ...
            <div class="main_certificate">
                <div class="certificate_all_content">
                    ...
                    <div class="certificate_body">
                        <p>Has been issued $1000.00 USD to be used towards up coming projects with Yehans International Company Limited.<br> In accordance with our company Policies, the credit would be applied towards the final estimate price of the project. The Commencement of the project validates the certificate of credit.<br> The certificate of Credit is Valid with the First month of Issue. An extension would be granted on a case to case situation. The credit certificate is Valid for any project of $10,000 USD or more.<br> Any additional discounts provided by Yehans International due to promotional sales can be approved or declined by the sales Manager responsible for the project.</p>
                    </div>
                    <div class="certificate_footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="certificate_footer_content certificate_approve">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="certificate_footer_content_address">
