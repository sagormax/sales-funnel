<div class="all_right_sidebar">
                <div class="box_style_2">
                    <h4>Contact Us</h4>
                    <h5>Yehans International</h5>
                    <ul>
                        <li><i class="fa fa-fax "></i>P. O. Box CT 5341</li>
                        <li><i class="fa fa-map-marker "></i>Cantonments, Accra.
                        </li>
                        <li><i class="fa fa-phone "></i>Local: 0 302 512 525
                        </li>
                ...
                <div class="box_style_2 sidebar_margin">
                    <h4>Testimonial</h4>
                    ...
                    <div class="right_sidebar right_sidebar_margir">
                       <div class="sidebar_images">
